...
export function generateInitialPlayers(): Player[] {
  ...
  const getTierValue = (gamemode: string) => {
    return formData[`${gamemode}_tier` as keyof typeof formData] as string
  }

  const getPointsValue = (gamemode: string) => {
    return formData[`${gamemode}_points` as keyof typeof formData] as number
  }
              ...
              <form onSubmit={handleAddPlayer} className="space-y-6">
                ...
                <div className="bg-background/50 p-4 rounded-lg border-2 border-accent/20">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-6 gap-2">
                    {TIER_ORDER.map((tier) => {
                      ...
                      const isSelected = getTierValue(selectedGamemode) === tier
                      return (
                        <button
                          key={tier}
                          type="button"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={getPointsValue(selectedGamemode)}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
